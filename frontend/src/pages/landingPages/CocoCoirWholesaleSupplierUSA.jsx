...
const CocoCoirWholesaleSupplierUSA = () => {
    ...
    const faqs = [
        {
                "q": "Why choose Cocoveera as your USA coir wholesale supplier?",
                "a": "We combine direct factory manufacturing with rigorous quality control, verified lab testing, low EC guarantees, and end-to-end container export service."
        },
        {
                "q": "Do you provide phytosanitary and export compliance certificates for USA import?",
                "a": "Yes, every export container is inspected and issued an official Phytosanitary Certificate meeting USDA-APHIS import standards."
        },
        {
                "q": "What is the minimum order quantity (MOQ) for USA bulk orders?",
                "a": "Our standard minimum order quantity for wholesale pricing is one 20ft or 40ft High Cube sea container. LCL options are also available."
        },
        {
                "q": "Can you supply custom blends of coir pith, fiber, and chips?",
                "a": "Yes, we produce custom physical blends (e.g., 70/30 coir pith/chips, 50/50 mix, or coarse husk chips) to suit specific crop drainage requirements."
        },
        {
                "q": "How do we establish a long-term wholesale supply contract?",
                "a": "Reach out to our global sales director via our website contact form or request a callback to discuss annual supply agreements and scheduled container deliveries."
        }
];
    ...
    const pageUrl = `${siteUrl}/coco-coir-wholesale-supplier-usa`;
    ...
    const schemaData = [
        {
            ...
            "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "coco coir wholesale supplier USA", "item": pageUrl }
            ]
        },
        {
            "@context": "https://schema.org",
    ...
    return (
        <div className="landing_page_parent">
            <SEO
                title="Coco Coir Wholesale Supplier USA | Bulk Substrate Export"
                description="Cocoveera is a leading coco coir wholesale supplier serving commercial growers, greenhouses, soil manufacturers, and distributors in the USA."
                url="/coco-coir-wholesale-supplier-usa"
                schema={schemaData}
            />
            ...
            <div className="bg-emerald-950 text-white/80 py-2.5 px-4 sm:px-8 text-xs font-medium border-b border-emerald-900/50">
                <div className="max-w-7xl mx-auto flex items-center gap-2">
                    ...
                    <span>/</span>
                    <span className="text-emerald-400 font-semibold">coco coir wholesale supplier USA</span>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-emerald-100/90 leading-relaxed max-w-2xl">
                            Your dependable global partner for bulk coconut coir blocks, grow bags, chips, and custom substrates exported direct to commercial buyers across the USA.
                        </p>
                    ...
                    <div className="relative">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-emerald-900/30">
                            <ImageWithFallback 
                                ...
                                alt="coco coir wholesale supplier USA" 
            ...
            <section className="py-16 bg-stone-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center space-y-4">
                        <h2 className="text-2xl sm:text-3xl font-bold text-stone-900">Who is Behind Cocoveera?</h2>
            ...
            <section className="py-16 bg-white border-y border-stone-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h2 className="text-2xl sm:text-3xl font-bold text-stone-900">Wholesale Advantage for USA Commercial Buyers</h2>
            ...
            <section className="py-16 bg-emerald-950 text-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
                        <h2 className="text-2xl sm:text-3xl font-bold">Order-to-Delivery Process for USA Buyers</h2>
